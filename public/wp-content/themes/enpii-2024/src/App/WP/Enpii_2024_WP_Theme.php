...
namespace WP_Theme_Enpii_2024\App\WP;

use Enpii_Base\Deps\Illuminate\Contracts\Container\BindingResolutionException;
use Enpii_Base\Foundation\WP\WP_Theme;
use WP_Theme_Enpii_2024\App\Support\Traits\Enpii_Theme_Trans_Trait;

class Enpii_2024_WP_Theme extends WP_Theme {
	use Enpii_Theme_Trans_Trait;

	public function get_name(): string {
		return $this->__( 'Enpii Theme' );
	}
